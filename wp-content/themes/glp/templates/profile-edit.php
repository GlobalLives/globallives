...
<form action="/profile" method="post" enctype="multipart/form-data" id="user-<?php echo $profile->ID; ?>" class="profile-edit-form container">
	...
	<div class="profile-container row">
		<div class="profile-sidebar span3">
			<div class="profile-siderbar-inner">
				...
				<hr>
				<p>
					<b><?php _e('Contact Information','glp'); ?></b>
					<br>
					<?php

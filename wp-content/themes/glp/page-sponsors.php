  ...
  <div class="row">
    ...
    <div class="col-sm-9">
      <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <?php the_content(); ?>
        <?php $rows = get_field('sponsor'); //sets the feildname of ACF
        ; ?>
        ...
        ?>
          <div class="col-sm-4 text-center">
            <a href="http://<?php echo $individual['sponsor_url']; //getting the repeater information ?>"><?php $logo = $individual['sponsor_logo']; //getting the repeater information ?>
